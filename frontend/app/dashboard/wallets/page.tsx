            ...
            wallets.map((wallet) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 mb-2">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-mono text-white">{wallet.win_rate?.toFixed(1)}%</span>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-[10px] text-zinc-500 uppercase mb-1">ROI</div>
                ...
                <div className="flex justify-between pt-2 border-t border-white/5">
                  ...
                  <div className="text-right">
                    <div className="text-[10px] text-zinc-500 uppercase">Realized PnL</div>
                    <div className={cn("text-sm font-mono font-bold",
                      (wallet.realized_pnl || 0) > 0 ? "text-emerald-400" : "text-red-400"
                    )}>
                      {(wallet.realized_pnl || 0) > 0 ? '+' : ''}{formatCurrency(wallet.realized_pnl)}

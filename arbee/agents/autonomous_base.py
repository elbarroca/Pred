...
from arbee.utils.rich_logging import setup_rich_logging, RichAgentLogger
...
class AutonomousReActAgent(ABC):
    ...
    def __init__(
        ...
        *,
        ...
        assert not self.enable_auto_memory_query or self.store is not None, \
            "Memory store required when enable_auto_memory_query=True"
